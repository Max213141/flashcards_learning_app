...
typedef CardSwipeCompleteCallback =
    void Function(CardSwipeOrientation orientation, int index);

/// [DragUpdateDetails] of swiping card.
typedef CardDragUpdateCallback =
    void Function(DragUpdateDetails details, Alignment align);
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    /* Trigger Swipe Up or Down */
      ...
      var beginY = _TinderSwapCardState._trigger == TriggerDirection.up
          ? -10
          : 10;
